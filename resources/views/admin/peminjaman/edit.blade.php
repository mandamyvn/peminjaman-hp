...
<div class="container-fluid">
    <div class="card-yellow">
        <div class="card-header-yellow">
            <h3 class="card-title">
                <i class="fas fa-edit me-2"></i> Edit Peminjaman: {{ $peminjaman->kode_peminjaman }}
            </h3>
            ...
            <form action="{{ route('admin.peminjaman.update', $peminjaman) }}" method="POST">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control-yellow @error('jumlah') is-invalid @enderror" 
                                   id="jumlah" name="jumlah" value="{{ old('jumlah', $peminjaman->jumlah) }}" min="1" required>
                            @error('jumlah')
                                <span class="invalid-feedback" style="color: #dc3545; font-size: 12px;">{{ $message }}</span>
                            @enderror
                        </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control-yellow @error('keperluan') is-invalid @enderror" 
                              ...
                              placeholder="Jelaskan keperluan peminjaman..." required>{{ old('keperluan', $peminjaman->keperluan) }}</textarea>
                    @error('keperluan')
                        <span class="invalid-feedback" style="color: #dc3545; font-size: 12px;">{{ $message }}</span>
                    @enderror
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea class="form-control-yellow @error('catatan_admin') is-invalid @enderror" 
                                      ...
                                      placeholder="Catatan internal untuk admin (opsional)">{{ old('catatan_admin', $peminjaman->catatan_admin) }}</textarea>
                            @error('catatan_admin')
                                <span class="invalid-feedback" style="color: #dc3545; font-size: 12px;">{{ $message }}</span>
                            @enderror
                        </div>
